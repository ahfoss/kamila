...
# kamila [![R-CMD-check](https://github.com/ahfoss/kamila/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ahfoss/kamila/actions/workflows/R-CMD-check.yaml) [![CRAN_Status_Badge](https://cranlogs.r-pkg.org/badges/grand-total/kamila)](https://cran.r-project.org/package=kamila) [![CRAN_Status_Badge](https://cranlogs.r-pkg.org/badges/kamila)](https://cran.r-project.org/package=kamila)
